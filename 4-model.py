...
# Fit the model
history = model.fit(x=train_XN, y=train_Y, validation_data=(dev_XN, dev_Y), epochs=200, batch_size=128)
...
confusion = confusion_matrix(test_Y, prediction, normalize='true')
print(confusion)
